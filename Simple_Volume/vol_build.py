#!/usr/bin/env python3
"""Build the Vol ZDL from vol.c + manifest.json."""
...
TI_ROOT = Path("C:/ti/ccs2051/ccs/tools/compiler/ti-cgt-c6000_8.5.0.LTS")
...
def main() -> None:
    ...
    print(f"[vol] compiling {src_c.name} -> {obj.name}")
    subprocess.run(
        [
            str(CL6X),
            *CFLAGS,
